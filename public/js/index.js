...
for (let key of keys) {
    ...
    if (productsStored.categoria === 1) {
        ...
        block.classList.add('detail-product', `detail-product-${productsStored.id}`);
    }
    ...
    blockDescription.classList.add('description-product', `description-product-${productsStored.id}`);
    const blockProductImg = document.createElement('img');
    document
        .querySelector(`.product-${productsStored.id}`)
        .appendChild(blockProductImg);
    blockProductImg.classList.add('product__img', `product__img-${productsStored.id}`);
    ...
    blockDetailsSizes.classList.add('details__sizes', `details__sizes-${productsStored.id}`);
    ...
    blockDetailsRadiosP.classList.add('details__radios', `details__radios-p-${productsStored.id}`);
    const blockDetailsRadiosM = document.createElement('div');
    document
        .querySelector(`.details__sizes-${productsStored.id}`)
        .appendChild(blockDetailsRadiosM);
    blockDetailsRadiosM.classList.add('details__radios', `details__radios-m-${productsStored.id}`);
    const blockDetailsRadiosG = document.createElement('div');
    document
        .querySelector(`.details__sizes-${productsStored.id}`)
        .appendChild(blockDetailsRadiosG);
    blockDetailsRadiosG.classList.add('details__radios', `details__radios-g-${productsStored.id}`);
    ...
    blockDetailsLabelP.classList.add('details__label', `details__label-p-${productsStored.id}`);
    ...
    blockDetailsLabelM.classList.add('details__label', `details__label-m-${productsStored.id}`);
    ...
    blockDetailsLabelG.classList.add('details__label', `details__label-g-${productsStored.id}`);
    ...
    blockDetailsInputP.classList.add('details__input', `details__input-p-${productsStored.id}`);
    ...
    blockDetailsInputM.classList.add('details__input', `details__input-m-${productsStored.id}`);
    ...
    blockDetailsInputG.classList.add('details__input', `details__input-g-${productsStored.id}`);
    ...
    blockDetailsSpanP.classList.add('details__span', `details__span-p-${productsStored.id}`);
    const blockDetailsSpanM = document.createElement('span');
    document
        .querySelector(`.details__label-m-${productsStored.id}`)
        .appendChild(blockDetailsSpanM).innerHTML = 'M';
    blockDetailsSpanM.classList.add('details__span', `details__span-m-${productsStored.id}`);
    const blockDetailsSpanG = document.createElement('span');
    document
        .querySelector(`.details__label-g-${productsStored.id}`)
        .appendChild(blockDetailsSpanG).innerHTML = 'G';
    blockDetailsSpanG.classList.add('details__span', `details__span-g-${productsStored.id}`);
    ...
    blockNameProduct.classList.add('name-product', `name-product-${productsStored.id}`);
    const blockValueProduct = document.createElement('p');
    document
        .querySelector(`.description-product-${productsStored.id}`)
        .appendChild(blockValueProduct).innerHTML = `R$ ${valueProductFormat}`;
    blockValueProduct.classList.add('value-product', `value-product-${productsStored.id}`);
    ...
    blockAddContent.classList.add('add__content', `add__content-${productsStored.id}`);
