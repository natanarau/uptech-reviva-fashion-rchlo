...
keys.forEach((key) => {
  ...
  if (productsStored.carrinho > 0) {
    ...
    blockCart.classList.add(
      'box-cart__product',
      `box-cart__product-${productsStored.id}`,
    );
    ...
    blockCardImg.classList.add(
      'box-cart__img',
      `box-cart__img-${productsStored.id}`,
    );
    ...
    blockCardName.classList.add(
      'box-cart__name',
      `box-cart__name-${productsStored.id}`,
    );
    ...
    blockCardTitle.classList.add(
      'box-cart__title',
      `box-cart__title-${productsStored.id}`,
    );
    ...
    blockCardDesc.classList.add(
      'box-cart__desc',
      `box-cart__desc-${productsStored.id}`,
    );
    ...
    blockCardSize.classList.add(
      'box-cart__size',
      `box-cart__size-${productsStored.id}`,
    );
    ...
    blockCardTitleSize.classList.add(
      'box-cart__title',
      `box-cart__title-${productsStored.id}`,
    );
    ...
    boxCartValue.classList.add(
      'box-cart__value',
      `box-cart__value-${productsStored.id}`,
    );
    ...
    boxCartTitleValue.classList.add(
      'box-cart__title',
      `box-cart__title-${productsStored.id}`,
    );
    ...
    boxCartDesc.classList.add(
      'box-cart__desc',
      `box-cart__desc-value-${productsStored.id}`,
    );
    ...
    document
      ...
      .appendChild(
        boxCartValueProducts,
      ).innerHTML = `R$ ${productsStored.preco}`;
    boxCartValueProducts.classList.add(
      'value-product',
    ...
    boxCartQt.classList.add(
      'box-cart__qt',
      `box-cart__qt-${productsStored.id}`,
    );
    ...
    boxCartInputQt.classList.add(
      'box-cart__input',
      `box-cart__input-${productsStored.id}`,
    );
    ...
    boxCartInputQt.setAttribute(
      'max',
      `${productsStored.quantidade_disponivel}`,
    );
    ...
    boxCartSubTotal.classList.add(
      'box-cart__sub-total',
      `box-cart__sub-total-${productsStored.id}`,
    );
    ...
    boxCartSubTotalValue.classList.add(
      'box-cart__desc',
      `box-cart__desc-subtotal-${productsStored.id}`,
    );
    ...
    boxCartSubTotalResult.classList.add(
      'subTotal',
      `subTotal-${productsStored.id}`,
    );
