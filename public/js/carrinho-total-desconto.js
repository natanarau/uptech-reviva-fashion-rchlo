...
const noDiscount = carrinho
    ...
    if (!productDiscount.includes(valueProduct) &&
...
const totalDiscountedProducts = productDiscount.reduce((acc, valueCurrent) => calculator(acc, valueCurrent * discount), 0);
const totalToBePaid = noDiscount - productToHaveDiscounted + totalDiscountedProducts;
